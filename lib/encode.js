...
// Sticking them in an array of buffers makes it easier to prepend headers,
// and there's always Buffer.concat().
...
Encoder.prototype.writeNull = function() {
  this.ensure(1);
  this.buf.writeUint8LE(0, this.pos++);
};

// data can be whatever.
Encoder.prototype.writeBool = function(data) {
  this.ensure(1);
  this.buf.writeUint8LE(data ? 1 : 0, this.pos++);
};
